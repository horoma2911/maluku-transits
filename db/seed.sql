...
(1, 'TRP-2026-001', 'Dar es Salaam', 'Dodoma', 'T 123 ABC', 'Juma Mwinyi', '2026-07-15', 'in_transit', 'TZS 85,000'),
(2, 'TRP-2026-002', 'Mwanza', 'Arusha', 'E 567 BCD', 'Hassan Said', '2026-07-14', 'completed', 'TZS 45,000'),
(3, 'TRP-2026-003', 'Mbeya', 'Morogoro', 'R 901 CDE', 'Salum Issa', '2026-07-14', 'pending', 'TZS 62,000'),
(4, 'TRP-2026-004', 'Dar es Salaam', 'Moshi', 'Z 789 EFG', 'Ramadhani Ali', '2026-07-13', 'completed', 'TZS 120,000'),
(5, 'TRP-2026-005', 'Tanga', 'Dodoma', 'T 123 ABC', 'Juma Mwinyi', '2026-07-12', 'cancelled', 'TZS 0');
...
(1, 'PO-2026-001', 'Toyota Tanzania Ltd', '2026-07-15', 'TZS 125,000', 'pending'),
(2, 'PO-2026-002', 'TotalEnergies Tanzania', '2026-07-14', 'TZS 250,000', 'approved'),
(3, 'PO-2026-003', 'Bridgestone TZ', '2026-07-13', 'TZS 420,000', 'delivered');

INSERT INTO expenses (id, ref, category, amount, date, trip, status) VALUES
(1, 'EXP-001', 'Fuel', 85000.00, '2026-07-15', 'TRP-2026-001', 'approved'),
(2, 'EXP-002', 'Maintenance', 45000.00, '2026-07-14', 'N/A', 'pending'),
(3, 'EXP-003', 'Insurance', 120000.00, '2026-07-13', 'N/A', 'approved'),
(4, 'EXP-004', 'Salary', 350000.00, '2026-07-01', 'N/A', 'approved');

INSERT INTO invoices (id, ref, client, date, amount, due, status) VALUES
(1, 'INV-2026-001', 'Tanzania Breweries Ltd', '2026-07-15', 'TZS 185,000', '2026-08-15', 'pending'),
(2, 'INV-2026-002', 'Air Tanzania', '2026-07-14', 'TZS 120,000', '2026-08-14', 'paid'),
(3, 'INV-2026-003', 'CRDB Bank', '2026-07-13', 'TZS 95,000', '2026-08-13', 'overdue');

INSERT INTO payments (id, ref, method, amount, date, status) VALUES
(1, 'PAY-2026-001', 'Bank Transfer', 'TZS 120,000', '2026-07-14', 'completed'),
(2, 'PAY-2026-002', 'M-Pesa', 'TZS 45,000', '2026-07-13', 'completed'),
...
(3, 'Accountant', 'Processed invoice INV-2026-002', '5 hours ago', 'fa-file-invoice'),
(4, 'Ops Manager', 'Approved expense EXP-004', 'Yesterday', 'fa-check-circle'),
(5, 'Dispatcher', 'Assigned driver to trip TRP-2026-004', 'Yesterday', 'fa-user-plus');

SELECT setval('vehicles_id_seq', (SELECT MAX(id) FROM vehicles));
SELECT setval('trailers_id_seq', (SELECT MAX(id) FROM trailers));
